...
export default class PrepsMessageTokenUpdatePage {
  pageTitle: ElementFinder = element(by.id('prepaymentsDevApp.prepsPrepsMessageToken.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  descriptionInput: ElementFinder = element(by.css('input#preps-message-token-description'));
  timeSentInput: ElementFinder = element(by.css('input#preps-message-token-timeSent'));
  tokenValueInput: ElementFinder = element(by.css('input#preps-message-token-tokenValue'));
  receivedInput: ElementFinder = element(by.css('input#preps-message-token-received'));
  actionedInput: ElementFinder = element(by.css('input#preps-message-token-actioned'));
  contentFullyEnqueuedInput: ElementFinder = element(by.css('input#preps-message-token-contentFullyEnqueued'));
