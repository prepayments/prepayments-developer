...
export default class PrepsFileUploadUpdatePage {
  pageTitle: ElementFinder = element(by.id('prepaymentsDevApp.prepsPrepsFileUpload.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  descriptionInput: ElementFinder = element(by.css('input#preps-file-upload-description'));
  fileNameInput: ElementFinder = element(by.css('input#preps-file-upload-fileName'));
  periodFromInput: ElementFinder = element(by.css('input#preps-file-upload-periodFrom'));
  periodToInput: ElementFinder = element(by.css('input#preps-file-upload-periodTo'));
  prepsFileTypeIdInput: ElementFinder = element(by.css('input#preps-file-upload-prepsFileTypeId'));
  dataFileInput: ElementFinder = element(by.css('input#file_dataFile'));
  uploadSuccessfulInput: ElementFinder = element(by.css('input#preps-file-upload-uploadSuccessful'));
  uploadProcessedInput: ElementFinder = element(by.css('input#preps-file-upload-uploadProcessed'));
  uploadTokenInput: ElementFinder = element(by.css('input#preps-file-upload-uploadToken'));
  ...
  async setPrepsFileTypeIdInput(prepsFileTypeId) {
    await this.prepsFileTypeIdInput.sendKeys(prepsFileTypeId);
  }

  async getPrepsFileTypeIdInput() {
    return this.prepsFileTypeIdInput.getAttribute('value');
  }
  ...
  async enterData() {
    ...
    await waitUntilDisplayed(this.saveButton);
    await this.setPrepsFileTypeIdInput('5');
    expect(await this.getPrepsFileTypeIdInput()).to.eq('5');
    await waitUntilDisplayed(this.saveButton);
